...
\item Modules of interest: Machine Learning, Computer Vision, Time Series Analysis, Algorithms, Compilers, Databases
\end{itemize}
...
\item Wrote new Kafka listener logic in the Commodities data ingestion pipeline to process a new supplier's metadata files
\item Developed an automated smoke tester for the Presto query engine serving the Commodities datalake
\end{itemize}
}}
