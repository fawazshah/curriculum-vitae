...
\item Currently building a custom online shop, using Google Cloud Platform and Docker
\end{itemize}
}}
...
\item Built a web server on a Raspberry Pi using a LAMP stack

\item Published a command line interface tool for currency conversion, written in JavaScript
