...
\\
Modules of interest: Java, Databases, Algorithms, Statistical Modelling, Numerical Analysis
}
...
{}{}{
\begin{itemize}
\item Redesigned the website using Foundation to make it more mobile-friendly (viewable at \href{https://www.solidaritee.org.uk/}{solidaritee.org.uk})
\item Built a bespoke online shop, using a LAMP stack running Magento and hosted on DigitalOcean (available at \href{https://shop.solidaritee.org.uk/}{shop.solidaritee.org.uk})
\end{itemize}
}}
...
\item Helped raise sponsorship money for IC Hack 19, leading to the most well-funded IC Hack in history
\end{itemize}
}}
