...
\item Implemented Java solutions in situations such as solving the shortest path problem, scheduling timetables and basic critical path analysis
...
{}{}{
\begin{itemize}
\item Implemented new features to automatically send data between two of Netcraft's biggest services, C2 and Takedown
...
\item Integrated C2 with the older Contracts system, and rewrote Contracts documentation to make it easier to integrate with newer systems
\end{itemize}
}}
...
{}{}{
\begin{itemize}
\item Worked with senior members of staff and other representatives to solve problems faced by JMC students
...
{}{}{
\begin{itemize}
\item Scheduled regular presentations throughout the year and encouraged younger students to give presentations themselves
\item Expanded the size of the society, by opening it up to all years instead of just 6th form and promoting it heavily
\item Organized a talk given by a senior developer at Oracle, achieving record turnout to the Society
\end{itemize}
}}
