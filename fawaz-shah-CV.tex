...
\begin{tabular}{ l l }
Proficient in: & \textbf{Java, C, HTML, CSS} \\
Previously used: & \textbf{Python, Perl, SQL, JavaScript}
\end{tabular}
...
{}{}{
\begin{itemize}
\item Implemented functionality so that malicious URLs can be automatically taken down based on certificate authority
\item Wrote feature to stop taking down malicious URLs and mailservers for a company if their Netcraft contract has expired
\item Refactored old Perl and SQL codebases for ease of use, gained experience in full stack development
...
{}{}{
\begin{itemize}
\item Redesigned the website front-end to make it more mobile-friendly
\item Gained experience with npm and ZURB Foundation
\end{itemize}
}}
...
{}{}{
\begin{itemize}
\item Wrote a guide on how to use Linux and the command line, aimed at 1st years with no programming experience
\item Currently negotiating £1000s of sponsorship with leading companies in the technology sector
...
\item I report any academic issues faced by JMC students to relevant lecturers or year directors
\end{itemize}
}}
...
{}{}{
\begin{itemize}
\item Gave regular presentations throughout the year, encouraged younger students to give presentations themselves
\item Expanded the size of the society, by opening it up to all years instead of just 6th form and promoting it heavily
\item Organized a talk given by a senior developer at Oracle Corporation, achieving record turnout (40+ students) to the Society
\end{itemize}
}}
